...
use App\Http\Controllers\NonVatReportController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::patch('/auth/tutorial', [AuthController::class, 'markTutorialSeen']);
    ...
    Route::middleware('client.active')->group(function () {
        ...
        Route::get('/reports/non-vat/2551q',     [NonVatReportController::class, 'quarterly2551q']);
    ...
    Route::middleware('role:accountant')->group(function () {
        ...
        Route::get('/accountant/clients/{id}/notes',   [Accountant\ClientController::class, 'notes']);
        Route::patch('/accountant/clients/{id}/notes', [Accountant\ClientController::class, 'updateNotes']);
    });
